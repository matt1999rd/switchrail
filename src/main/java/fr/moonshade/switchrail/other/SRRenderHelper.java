...
public class SRRenderHelper {
    ...
    public static void drawRectangle(VertexConsumer builder,TextureAtlasSprite sprite, PoseStack stack, float x1, float x2, float y1, float y2,float u0,float u1,float v0,float v1,int combinedLight,int color,float alpha) {
    ...
    public static void drawRectangle(VertexConsumer builder,TextureAtlasSprite sprite, PoseStack stack, float x1, float x2, float y1, float y2,int combinedLight,int color,float alpha) {
